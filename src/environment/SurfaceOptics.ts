 ...
 *
 * The base ocean remains responsible for the actual visible water body and wave height.
 * This cheaper secondary surface adds micro-ripple sparkle from above and a distorted,
 * brighter Snell-window / total-internal-reflection boundary from below. Keeping it separate
 * makes the effect easy to tune or disable without destabilising surface crossing physics.
 */
    ...
    this.material = new ShaderMaterial({
      ...
      fragmentShader: /* glsl */ `
        ...
        void main() {
          ...
          // Slow local distortion makes the Snell boundary breathe with the ripples instead
          // of reading as a mathematically perfect circle pasted onto the sky.
          ...
          if (gl_FrontFacing) {
            // Above water: fine glints and Fresnel brighten the existing base ocean.
            ...
            // Underwater: bright refracted sky in Snell's window, darker reflected water
            // outside it, and a thin moving rim near the total-internal-reflection boundary.
            ...
            // Broken sun sparkle seen through the refracted window.
